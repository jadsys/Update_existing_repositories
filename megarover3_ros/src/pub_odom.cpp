...
int main(int argc, char** argv){
  ...
  //get params
  if(n.getParam("tf_prefix", robot_prefix))
  { // 読み込み成功
  ...
  ros::Subscriber odom_sub = n.subscribe("/" + robot_prefix + "rover_odo", 100, roverOdomCallback);
  ...
  while(n.ok()){
    ...
    odom_trans.header.frame_id = robot_prefix + "odom";
    odom_trans.child_frame_id = robot_prefix + "base_footprint";
    ...
    odom.header.frame_id = robot_prefix + "odom";
    ...
    //set the velocity
    odom.child_frame_id = robot_prefix + "base_footprint";
